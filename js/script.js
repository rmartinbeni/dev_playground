    ...
    var img = new Image();
    var vida = '<img style="width:16px;height:20px" src="img/vida.png">';
    var p1vidas = [];
    var p2vidas = [];
    ...
    function muestraVidas(array) {
        var width = array.length * 8;
        var table = "<table style='width:" + width + ";height:20px'><tr>";
    ...
    var paddleRightX = canvas.width - 5;
    var paddleRightY = canvas.height / 2 - paddleHeight / 2;

    var paddleLeftX = 5;
    var paddleLeftY = canvas.height / 2 - paddleHeight / 2;
    ...
    function draw() {
        ...
        if (x + dx > canvas.width - ballRadius) {
            ...
            /*
                if (dy > 0) {
                    if (y - paddleRightY > 50 ) {
                        dy = +((y - paddleRightY - 50)/50);
                    } else {
                        dy = +((paddleRightY + 50 - y)/50);
                    }
                } else {
                    if (y - paddleRightY > 50 ) {
                        dy = -((y - paddleRightY - 50)/50);
